...
for Fid in range(len(filepath)):	
	...
	#clear()
	progressbar()
	print("Image: " +temp+ str(filepath[Fid]))
	#path=r'C:\Users\SRCOEM\Desktop\Image_Dataset\img1\Apple___Apple_scab'
	#path="C:\Users\SRCOEM\Desktop\Image_Dataset\img1\Apple___Apple_scab\"+str(filepath[Fid])
	tt ='\/'
	path=temp+str(tt)+str(filepath[Fid])
	path1 =r''+str(path)
	print(path1)
	#path1=r'C:\Users\SRCOEM\Desktop\Image_Dataset\img1\Apple___Apple_scab\0a5e9323-dbad-432d-ac58-d291718345d9___FREC_Scab 3417_final_masked.jpg'
		#"r'"+str(filepath[Fid])+"'"
